...
- `docs/design/07-renderer.md:30` (§2 页面架构，第 8 条): the single-Trip
...
`/Users/kangyishuai/Workspace/core/ChinaTripWeaver/CLAUDE.md:72` (工作区根
文件，非本仓库内容，记录 2026-09-06 一次真实 16 天行程的九轮连跑结果):
...
4. **Journey 页位置示意：做。** Unlike the other three, this is not a new
   feature request: `07-renderer.md:30` (§2, point 8) already made
