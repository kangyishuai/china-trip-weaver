...
| AMap | v5 POI, v3 geocode/walk/transit/drive, v4 ride fingerprints | POI (`poi`, optional `types`/`city_limit`), nearby search (`poi_around`), geocode, route matrix | 8s POI/geocode; 12s route | No API call; deep link/static estimate → unknown. |
