...
scripts/ctw journey locate --journey plans/<name>/journey.json --locate-result plans/<name>/locate.json --base-revision 1 --output-json plans/<name>/journey-r2.json
